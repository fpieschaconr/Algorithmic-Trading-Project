...
def make_pipeline():
    ...
    working_capital_per_share_winsorized = working_capital_per_share.winsorize(min_percentile=0.05, max_percentile=0.95)
    forward_dividend_yield_winsorized = forward_dividend_yield.winsorize(min_percentile=0.05, max_percentile=0.95)
    peg_ratio_winsorized = peg_ratio.winsorize(min_percentile=0.05, max_percentile=0.95)
    trailing_dividend_yield_winsorized = trailing_dividend_yield.winsorize(min_percentile=0.05, max_percentile=0.95)
